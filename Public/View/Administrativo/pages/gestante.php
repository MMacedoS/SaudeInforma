  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editProfileModalLabel">Registro de Consulta de gestante</h5>
...
<script>
    $(document).ready( function () {
            showData("<?=ROTA_GERAL?>/Gestante/getAllGestante")
    ...
    $('#btnSalvar').click(function(event) {
        ...
        var id = $('#id').val();
        if(id == '') {
         return createData('<?=ROTA_GERAL?>/Gestante/addGestante', new FormData(document.getElementById("formularioVacina")));
        }    
        return updateData('<?=ROTA_GERAL?>/Gestante/updGestante/' + id, new FormData(document.getElementById("formularioVacina")), id);
    });
    ...
    {
        showData("<?=ROTA_GERAL?>/Gestante/findById/" + rowData[0])
    ...
    function prepareModalEditar(data) {
        ...
        $('#preview').attr('src', "<?=ROTA_GERAL?>/Public/Gestante/" + data[0].imagem);
            $('#imagePreview').show();
        $('#vacinaModal').modal('show');   
    }
</script>