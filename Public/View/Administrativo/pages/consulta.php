  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editProfileModalLabel">Registro de Consultas Clinicas</h5>
      ...
      <div class="modal-body">
        <form id="formularioVacina">
          ...
          <div class="mb-3">
            <label for="nameInput" class="form-label">Campanha</label>
...
<script>
    $(document).ready( function () {
            showData("<?=ROTA_GERAL?>/Consulta/getAllConsulta")
    ...
    $('#btnSalvar').click(function(event) {
        ...
        var id = $('#id').val();
        if(id == '') {
         return createData('<?=ROTA_GERAL?>/Consulta/addConsulta', new FormData(document.getElementById("formularioVacina")));
        }    
        return updateData('<?=ROTA_GERAL?>/Consulta/updConsulta/' + id, new FormData(document.getElementById("formularioVacina")), id);
    });
    ...
    {
        showData("<?=ROTA_GERAL?>/Consulta/findById/" + rowData[0])
    ...
    function prepareModalEditar(data) {
        ...
        $('#preview').attr('src', "<?=ROTA_GERAL?>/Public/Consulta/" + data[0].imagem);
            $('#imagePreview').show();
        $('#vacinaModal').modal('show');   
    }
</script>