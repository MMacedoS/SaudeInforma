  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editProfileModalLabel">Registro de Campanha de vacina</h5>
      ...
      <div class="modal-body">
        <form id="formularioVacina">
          ...
          <div class="row">
            <div class="col-lg-6">
                <div class="mb-3">
                    <label for="phoneInput" class="form-label">Data Inicio</label>
                    <input type="date" name="data_inicio" id="" class="form-control" required>
                </div>          
            </div>
            <div class="col-lg-6">
                <div class="mb-3">
                    <label for="phoneInput" class="form-label">Data Final</label>
                    <input type="date" name="data_final" id="" class="form-control" required>
                </div>  
            </div>
          </div>
          <div class="mb-3">
